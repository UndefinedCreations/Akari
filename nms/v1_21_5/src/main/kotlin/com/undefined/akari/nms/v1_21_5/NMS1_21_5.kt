...
object NMS_1_21_5 : NMS {
    ...
    override fun sendSpawnPackets(entity: Any, serverEntity: Any, players: List<Player>) {
        val entity = entity as? Display.ItemDisplay ?: return
        players.sendPackets(entity.getAddEntityPacket(serverEntity as ServerEntity),)
    }
